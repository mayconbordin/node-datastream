...
//
// References:
// Cormode, Graham, and S. Muthukrishnan. "An improved data stream summary: the 
//   count-min sketch and its applications." Journal of Algorithms 55.1 (2005):
//   58-75.
//
// Based on:
// https://tech.shareaholic.com/2012/12/03/the-count-min-sketch-how-to-count-
//   over-large-keyspaces-when-about-right-is-good-enough/
//
...
/**
 * @param {object} options The configuration options are:
 *                         - epsilon A value in the unit interval that sets the precision of the sketch
 *                         - delta   A value in the unit interval that sets the precision of the sketch
 *                         - k       A positive integer that sets the number of top items counted
 **/
var CountMinSketch = function(options) {
