...
//
// References:
// Shrivastava, Nisheeth, et al. "Medians and beyond: new aggregation techniques
...
/**
 * @class QDigest
 * @classdesc Answers approximate quantile queries: actual rank of the result of
 *            query(q) is in q-eps .. q+eps, where eps = log(sigma)/compressionFactor
